...
String cType = request.getParameter("board_type");
			  	...
			  	<div id = "title">
			  		<div id="title_left">
			  			<h5><b><% if (length > 13){ %>
							...
							<% }else{ %>
							<a href="Board.jsp?bId=<%=bId%>" id="toBoard"><%=title %></a>
							<% } %>			  			
			  			</b></h5>
			  		</div>
...
<div class= "container mt-5 mb-5">
	<div class="row" >
		...
		<div class="col-lg-8" align="right" style="padding:0px 60px 0px 0px">
			...
			<%}else if (!cType.equals("notice") && !user.equals("")) {%>
				<a href="InsertBoardForm.jsp?board_type=<%=cType %>"class="btn btn-secondary" style="background-color: #94716B; border: 0">+글작성</a>
			<% } %>
		</div>
	</div>
